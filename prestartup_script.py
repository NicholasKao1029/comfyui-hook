...
def setup():
    handler = RotatingFileHandler('something.log', maxBytes=500000, backupCount=5)
...
try:
    ...
    print(f"** Revision: {current_git_commit}")
except Exception as e:
    print(f"** failed to get current git commit: {str(e)}")
